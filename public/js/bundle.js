...
const showAlert = (type, msg) => {
  ...
  const markup = "\n    <div class=\"alert alert--".concat(normalizedType, "\" role=\"status\" aria-live=\"polite\">\n      <span class=\"alert__icon\" aria-hidden=\"true\">").concat(icon, "</span>\n      <span class=\"alert__message\">").concat(msg, "</span>\n    </div>\n  ");
...
const signup = async data => {
  try {
    ...
    const res = await _axios.default.post('/api/v1/user/signup', payload);
    ...
    var _err$response;
    const message = ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Signup failed. Please try again.';
...
const login = async (email, password) => {
  try {
    const res = await _axios.default.post('/api/v1/user/login', {
      password,
      email
    });
    if (res.data.status === 'success') {
...
const logout = async () => {
  try {
    const res = await (0, _axios.default)('/api/v1/user/logout');
    if (res.data.status === 'success') {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"menuBar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scroll = exports.openCloseMenubar = exports.CloseMenubar = void 0;
/* eslint-disable*/
const openCloseMenubar = (hamburger, nav) => {
  hamburger.classList.toggle('active');
  nav.classList.toggle('active');
};
exports.openCloseMenubar = openCloseMenubar;
const CloseMenubar = (hamburger, nav) => {
  hamburger.classList.remove('active');
  nav.classList.remove('active');
};
// Horizontal scroll for features
exports.CloseMenubar = CloseMenubar;
const scroll = (direction, container, value) => {
...
},{}],"filterProperties.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showSpinner = exports.renderListings = exports.hideSpinner = exports.handleUrlParams = exports.filterProperties = exports.escapeHtml = exports.buildFilteredFormData = exports.applyFilters = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
const renderListings = payload => {
  var _payload$data;
  const properties = (payload === null || payload === void 0 || (_payload$data = payload.data) === null || _payload$data === void 0 ? void 0 : _payload$data.data) || (payload === null || payload === void 0 ? void 0 : payload.data) || payload || [];
  const countEl = document.querySelector('.listings__count');
  const grid = document.querySelector('.listings__grid');
  if (!grid) return;
  if (countEl) countEl.textContent = properties.length === 0 ? 'No properties found for the specified fields!' : "Showing ".concat(properties.length, " properties in Addis Ababa");
  grid.innerHTML = properties.map(p => {
    var _p$location, _p$location2;
    const img = p.photos && (p.photos[1] || p.photos[0]) || 'property-1-main.jpg';
    const subcity = ((_p$location = p.location) === null || _p$location === void 0 ? void 0 : _p$location.subcity) || '';
    const city = ((_p$location2 = p.location) === null || _p$location2 === void 0 ? void 0 : _p$location2.city) || '';
    return "\n<a class=\"listing-card\" href=\"/".concat(p.slug, "\">\n  <div class=\"listing-card__img-wrap\">\n    <img class=\"listing-card__img\" src=\"/img/properties/").concat(escapeHtml(img), "\" alt=\"").concat(escapeHtml(p.title || ''), "\" onerror=\"this.src='/img/properties/property-1-main.jpg'\">\n    <span class=\"listing-card__tag\">").concat(escapeHtml(p.type || ''), "</span>\n  </div>\n  <div class=\"listing-card__body\">\n    <p class=\"listing-card__price\">&pound; ").concat(escapeHtml(p.rent || ''), " <span>/ month</span></p>\n    <p class=\"listing-card__type\">").concat(escapeHtml(p.type || ''), "</p>\n    <p class=\"listing-card__location\">").concat(escapeHtml(subcity), ", ").concat(escapeHtml(city), "</p>\n    <div class=\"listing-card__meta\">\n      <span class=\"listing-card__meta-item\">").concat(escapeHtml(p.bedroom || ''), "\n        <svg class=\"listing-card__icon\"><use xlink:href=\"/css/icons-sprite.svg#icon-bed\"></use></svg>\n      </span>\n      <span class=\"listing-card__meta-item\">").concat(escapeHtml(p.bathroom || ''), "\n        <svg class=\"listing-card__icon\"><use xlink:href=\"/css/icons-sprite.svg#icon-bath\"></use></svg>\n      </span>\n    </div>\n  </div>\n</a>");
  }).join('');
};
...
const filterProperties = async formData => {
  ...
  const url = "/api/v1/property".concat(params.toString() ? "?".concat(params.toString()) : '');
  const res = await _axios.default.get(url);
  return res.data;
};
exports.filterProperties = filterProperties;
const buildFilteredFormData = (form, sortSelect, searchInput) => {
  if (!form) return null;
  const rawFormData = new FormData(form);
  const filteredFormData = new FormData();
  for (const _ref of rawFormData.entries()) {
  ...
  if (sortSelect !== null && sortSelect !== void 0 && sortSelect.value) {
    filteredFormData.append('sort', sortSelect.value);
  }
  return filteredFormData;
};
exports.buildFilteredFormData = buildFilteredFormData;
const applyFilters = async (formData, submitBtn) => {
  if (!formData) return;
...
},{"axios":"../../node_modules/axios/index.js"}],"propertyDetail.js":[function(require,module,exports) {
"use strict";
...
const syncButtonState = () => {
  if (!requestViewingBtn) return;
  const hasRequest = (listingSidebar === null || listingSidebar === void 0 ? void 0 : listingSidebar.dataset.hasRequest) === 'true';
  if (hasRequest) {
...
const getPropertyId = () => listingSidebar === null || listingSidebar === void 0 ? void 0 : listingSidebar.dataset.propertyId;
const displayStatus = function (message) {
  let isError = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  (0, _alert.showAlert)(isError ? 'error' : 'success', message);
};
const createEnquiry = async payload => {
  ...
  try {
    var _res$data;
    const res = await _axios.default.post('/api/v1/enquiries', _objectSpread(_objectSpread({}, payload), {}, {
      property: propertyId
    }));
    ...
    var _err$response;
    displayStatus(((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Failed to send enquiry.', true);
    console.error('Enquiry error', err);
    return null;
  }
};
const getUserName = () => (listingSidebar === null || listingSidebar === void 0 ? void 0 : listingSidebar.dataset.userName) || '';
const submitViewingRequest = async event => {
  event.preventDefault();
  const userName = getUserName();
  const result = await createEnquiry({
    message: userName ? "".concat(userName, " requested to view your property.") : 'A user requested to view your property.',
...
const pollForResponse = async () => {
  ...
  try {
    var _res$data2;
    const res = await _axios.default.get("/api/v1/enquiries/me/".concat(propertyId));
    const enquiry = (_res$data2 = res.data) === null || _res$data2 === void 0 || (_res$data2 = _res$data2.data) === null || _res$data2 === void 0 ? void 0 : _res$data2.data;
    if (!enquiry) return;
    ...
    if (requestViewingBtn.dataset.enquiryStatus !== currentStatus) {
      ...
      if (currentStatus === 'accepted') {
        (0, _alert.showAlert)('success', 'Your request was accepted by the landlord.');
      } else if (currentStatus === 'declined') {
        (0, _alert.showAlert)('error', 'The landlord declined your request.');
      }
    }
  } catch (err) {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"enquiries.js":[function(require,module,exports) {
"use strict";
...
const handleResponse = async (button, action) => {
  var _responseForm$querySe, _responseForm$querySe2;
  const enquiryId = button === null || button === void 0 ? void 0 : button.dataset.enquiryId;
  if (!enquiryId) return;
  const responseForm = button.closest('.enquiry-card__response-form');
  const contactPreference = (responseForm === null || responseForm === void 0 || (_responseForm$querySe = responseForm.querySelector('[name="contactPreference"]')) === null || _responseForm$querySe === void 0 ? void 0 : _responseForm$querySe.value) || 'phone';
  const contactValue = (responseForm === null || responseForm === void 0 || (_responseForm$querySe2 = responseForm.querySelector('[name="contactValue"]')) === null || _responseForm$querySe2 === void 0 || (_responseForm$querySe2 = _responseForm$querySe2.value) === null || _responseForm$querySe2 === void 0 ? void 0 : _responseForm$querySe2.trim()) || '';
  try {
    var _res$data;
    const res = await _axios.default.patch("/api/v1/enquiries/".concat(enquiryId, "/respond"), {
      action,
      contactPreference,
      contactValue
    });
    if (((_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.status) === 'success') {
      (0, _alert.showAlert)('success', action === 'decline' ? 'Request declined.' : 'Request accepted.');
      window.location.reload();
    }
  } catch (err) {
    var _err$response;
    (0, _alert.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Unable to update the request.');
  }
};
const bindButtons = () => {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"postproperty.js":[function(require,module,exports) {
"use strict";
...
const postProperty = async function (data) {
  let isEdit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  let propertyId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  try {
    let res;
    if (isEdit && propertyId) {
      // Update existing property
      res = await _axios.default.patch("/api/v1/property/".concat(propertyId), data);
    } else {
      // Create new property
      res = await _axios.default.post('/api/v1/property', data);
    }
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', isEdit ? 'Property updated successfully!' : 'Property posted successfully!');
      window.setTimeout(() => {
    ...
    var _err$response;
    (0, _alert.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Error saving property!');
  }
};
...
exports.updateUserData = exports.updatePassword = exports.savePreferences = exports.deleteAccount = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/*eslint-disable*/
...
const updateUserData = async data => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', 'Profile updated successfully!');
      return res.data.data.user;
    }
  } catch (err) {
    var _err$response;
    console.error('Error updating user data:', err);
    (0, _alert.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Error updating profile!');
    throw err;
  }
};
...
const savePreferences = async preferences => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', 'Preferences saved successfully!');
      return res.data.data.user;
    }
  } catch (err) {
    var _err$response2;
    console.error('Error saving preferences:', err);
    (0, _alert.showAlert)('error', ((_err$response2 = err.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || 'Error saving preferences!');
    throw err;
  }
};
...
const updatePassword = async data => {
  try {
    ...
    var _err$response3;
    (0, _alert.showAlert)('error', ((_err$response3 = err.response) === null || _err$response3 === void 0 || (_err$response3 = _err$response3.data) === null || _err$response3 === void 0 ? void 0 : _err$response3.message) || 'Error updating password!');
  }
};
...
const deleteAccount = async () => {
  try {
    ...
    var _err$response4;
    (0, _alert.showAlert)('error', ((_err$response4 = err.response) === null || _err$response4 === void 0 || (_err$response4 = _err$response4.data) === null || _err$response4 === void 0 ? void 0 : _err$response4.message) || 'Error deleting account!');
  }
};
...
var _filterProperties = require("./filterProperties");
...
if (hamburger && nav) {
  hamburger.addEventListener('click', () => {
    (0, _menuBar.openCloseMenubar)(hamburger, nav);
  });

  // Close mobile menu when clicking outside
  document.addEventListener('click', e => {
    if (!nav.contains(e.target) && !hamburger.contains(e.target)) {
      (0, _menuBar.CloseMenubar)(hamburger, nav);
    }
  });
}
// Horizontal scroll for features
if (scrollContainer && scrollLeft && scrollRight) {
  (0, _menuBar.scroll)(scrollLeft, scrollContainer, -360);
  (0, _menuBar.scroll)(scrollRight, scrollContainer, 360);
}

// Horizontal scroll for testimonials
if (testimonialsContainer && testimonialsLeft && testimonialsRight) {
  (0, _menuBar.scroll)(testimonialsLeft, testimonialsContainer, -420);
  (0, _menuBar.scroll)(testimonialsRight, testimonialsContainer, 420);
}
...
if (signupBtn) {
  ...
  signupBtn.addEventListener('submit', async e => {
    ...
    const name = "".concat(firstName, " ").concat(lastName).trim();
    ...
    formData.append('phoneNumber', phoneDigits ? "+251".concat(phoneDigits) : '');
    ...
    await (0, _signup.signup)(formData);
  });
}
//////////////////////////////////////////
//login
...
if (filterBtn) {
  filterBtn.addEventListener('submit', async e => {
    e.preventDefault();
    const filteredFormData = (0, _filterProperties.buildFilteredFormData)(form, sortSelect);
    await (0, _filterProperties.applyFilters)(filteredFormData, submitBtn);
  });
}
// sort functionality
if (sortSelect) {
...
if (searchBtn) {
  searchBtn.addEventListener('submit', async e => {
    ...
    e.preventDefault();
    const searchValue = searchInput === null || searchInput === void 0 || (_searchInput$value = searchInput.value) === null || _searchInput$value === void 0 ? void 0 : _searchInput$value.trim();
    if (searchValue) {
      // Redirect to property-listings page with search parameter in URL
      location.assign("/property-listings?location.subcity=".concat(encodeURIComponent(searchValue)));
    } else {
...
if (postForm) {
  ...
  postForm.addEventListener('submit', async e => {
    ...
    await (0, _postproperty.postProperty)(formData, isEdit, propertyId);
  });
}
...
if (userDataForm) {
  ...
  userDataForm.addEventListener('submit', async e => {
    ...
    const bio = ((_document$getElementB = document.getElementById('userBio')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.value) || '';
    const photoFile = document.getElementById('photo').files[0];
    ...
    const updatedUser = await (0, _updateSettings.updateUserData)(formData);
    if (updatedUser && updatedUser.photo) {
      const preview = document.querySelector('.form__profile-photo-image');
      if (preview) {
        preview.src = "/img/users/".concat(updatedUser.photo, "?t=").concat(Date.now());
      }
      const headerAvatar = document.querySelector('.header__nav--avatar');
      if (headerAvatar) {
        headerAvatar.src = "/img/users/".concat(updatedUser.photo, "?t=").concat(Date.now());
      }
    }
  });
}
...
if (notificationsForm) {
  ...
  fetch('/api/v1/user/me').then(res => res.json()).then(data => {
  ...
  notificationsForm.addEventListener('submit', async e => {
    ...
    await (0, _updateSettings.savePreferences)(preferences);
  });
}
  ...
  deleteBtn.addEventListener('click', async () => {
    if (confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
      if (confirm('This will permanently delete all your listings, enquiries, and personal data. Continue?')) {
        await (0, _updateSettings.deleteAccount)();
      }
    }
  });
}
...
if (settingsNavLinks.length && settingsSections.length) {
  ...
  const onScroll = () => {
    ...
    const activeLink = document.querySelector(".settings-nav-link[href=\"#".concat(activeSection.id, "\"]"));
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', async e => {
    ...
    if (!email) {
      (0, _alert.showAlert)('error', 'Please enter your email address.');
      return;
    }
    try {
      const res = await _axios.default.post('/api/v1/user/forgetPassword', {
        email
      });
      if (res.data.status === 'success') {
        (0, _alert.showAlert)('success', 'Password reset link sent! Check your email.');
      }
    } catch (err) {
      var _err$response;
      (0, _alert.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Error sending reset email.');
    }
  });
}
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', async e => {
    ...
    if (!password || !passwordConfirm) {
      (0, _alert.showAlert)('error', 'Please fill in both password fields.');
      return;
    }
    if (password.length < 8) {
      (0, _alert.showAlert)('error', 'Password must be at least 8 characters.');
      return;
    }
    if (password !== passwordConfirm) {
    ...
    try {
      const res = await _axios.default.patch("/api/v1/user/resetPassword/".concat(resetToken), {
        password,
        passwordConfirm
      });
      if (res.data.status === 'success') {
        (0, _alert.showAlert)('success', 'Password updated! Redirecting to login...');
        setTimeout(() => {
      ...
      var _err$response2;
      (0, _alert.showAlert)('error', ((_err$response2 = err.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || 'Error resetting password.');
    }
  });
}
},{"core-js/modules/es7.array.flat-map.js":"../../node_modules/core-js/modules/es7.array.flat-map.js","core-js/modules/es6.array.sort.js":"../../node_modules/core-js/modules/es6.array.sort.js","core-js/modules/es7.promise.finally.js":"../../node_modules/core-js/modules/es7.promise.finally.js","core-js/modules/es7.symbol.async-iterator.js":"../../node_modules/core-js/modules/es7.symbol.async-iterator.js","core-js/modules/es7.string.trim-left.js":"../../node_modules/core-js/modules/es7.string.trim-left.js","core-js/modules/es7.string.trim-right.js":"../../node_modules/core-js/modules/es7.string.trim-right.js","core-js/modules/web.timers.js":"../../node_modules/core-js/modules/web.timers.js","core-js/modules/web.immediate.js":"../../node_modules/core-js/modules/web.immediate.js","core-js/modules/web.dom.iterable.js":"../../node_modules/core-js/modules/web.dom.iterable.js","./signup":"signup.js","./login":"login.js","./menuBar":"menuBar.js","./filterProperties":"filterProperties.js","./propertyDetail":"propertyDetail.js","./enquiries":"enquiries.js","./postproperty":"postproperty.js","axios":"../../node_modules/axios/index.js","./updateSettings":"updateSettings.js","./alert":"alert.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
