...
const postProperty = async data => {
  try {
    const res = await _axios.default.post('/api/v1/property', data);
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', 'Property posted successfully!');
      window.setTimeout(() => {
    ...
    var _err$response;
    (0, _alert.showAlert)('error', ((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Error posting property!');
  }
};
...
if (postForm) {
  postForm.addEventListener('submit', async e => {
    ...
    e.preventDefault();
    const title = (_document$getElementB = document.getElementById('title')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.value;
    const type = (_document$getElementB2 = document.getElementById('property-type')) === null || _document$getElementB2 === void 0 || (_document$getElementB2 = _document$getElementB2.value) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.toLowerCase().replace(' ', '-');
    const rent = (_document$getElementB3 = document.getElementById('rent')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.value;
    const city = (_document$getElementB4 = document.getElementById('city')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.value;
    const subcity = (_document$getElementB5 = document.getElementById('subcity')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.value;
    const woreda = (_document$getElementB6 = document.getElementById('woreda')) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.value;
    const kebele = (_document$getElementB7 = document.getElementById('kebele')) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.value;
    const bedroom = (_document$getElementB8 = document.getElementById('bedrooms')) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.value;
    const bathroom = (_document$getElementB9 = document.getElementById('bathrooms')) === null || _document$getElementB9 === void 0 ? void 0 : _document$getElementB9.value;
    const description = (_document$getElementB0 = document.getElementById('description')) === null || _document$getElementB0 === void 0 ? void 0 : _document$getElementB0.value;
