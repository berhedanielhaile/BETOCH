...
exports.updateUserData = exports.updateSettings = exports.updatePassword = exports.savePreferences = exports.deleteAccount = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/*eslint-disable*/
...
const updateUserData = async data => {
  try {
    ...
    (0, _alert.showAlert)('error', ((_err$response2 = err.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || 'Error updating profile!');
    throw err;
  }
};
...
const savePreferences = async preferences => {
  try {
    ...
    (0, _alert.showAlert)('error', ((_err$response3 = err.response) === null || _err$response3 === void 0 || (_err$response3 = _err$response3.data) === null || _err$response3 === void 0 ? void 0 : _err$response3.message) || 'Error saving preferences!');
    throw err;
  }
};
...
const updatePassword = async data => {
  try {
    ...
    var _err$response4;
    (0, _alert.showAlert)('error', ((_err$response4 = err.response) === null || _err$response4 === void 0 || (_err$response4 = _err$response4.data) === null || _err$response4 === void 0 ? void 0 : _err$response4.message) || 'Error updating password!');
  }
};
...
const deleteAccount = async () => {
  try {
    ...
    var _err$response5;
    (0, _alert.showAlert)('error', ((_err$response5 = err.response) === null || _err$response5 === void 0 || (_err$response5 = _err$response5.data) === null || _err$response5 === void 0 ? void 0 : _err$response5.message) || 'Error deleting account!');
  }
};
...
if (postForm) {
  postForm.addEventListener('submit', async e => {
    ...
    (0, _postproperty.postProperty)(data, isEdit, propertyId);
  });
}
